...
function procurar() {
    ...
    for (let tag of tagsHtml) {
        ...
        if (tag.titulo.includes(campoPesquisa)||
            ...
            <div class="item-resultado">
                <h2>
                    <img src="/Desafio Final/Ícones/html-5-svgrepo-com.svg" alt="ícone do HTML5" width="50" height="50"> ${tag.titulo}
                </h2>
    ...
    for (let conceito of cssConceitos) {
        ...
        resultados += // O += vai adicionar o conteúdo do HTML dentro da variável section.
            ...
            <div class="item-resultado">
                <h2>
                    <img src="/Desafio Final/Ícones/css-3-svgrepo-com.svg" alt="ícone do CSS" width="50" height="50"> ${conceito.titulo}
                </h2>
    ...
    for (let conceito of jsConceitos) {
        ...
        <div class="item-resultado">
            <h2>
                <img src="/Desafio Final/Ícones/javascript-svgrepo-com.svg" alt="ícone do JavaScript" width="50" height="50"> ${conceito.titulo}
            </h2>
